        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="attendance_export.php" class="btn btn-success btn-sm btn-flat" style="margin-left: 5px;"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
              </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    // Lógica para obtener los datos de asistencia de la BD
                    ...
                    while($row = $query->fetch_assoc()){
                      // Determina si la entrada fue 'a tiempo' o 'tarde'
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      // Rellenar campos del modal de Eliminación
